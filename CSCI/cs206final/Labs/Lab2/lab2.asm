...
loop:
	add		$t1, $t1, $t0		# add this number to the sum
	addi		$t0, $t0, 1		# increment counter
	ble		$t0, 10, loop		# check for done
...
#The error was caused by invalide instruction in line 46. It was 'abdi' which is supposed to be addi.
